%Przyk³adowy plik u³atwiaj±cy z³o¿enie projektu dyplomowego in¿ynierskiego.
%UWAGA: Generowany napis na stronie tytu³owej o tre¶ci PROJEKT DYPLOMOWY IN¯YNIERSKI zosta³ zaproponowany przeze mnie i nie jest, póki co, potwierdzony przez w³adze wydzia³u. Przed ostatecznym oddaniem tak z³o¿onej pracy nale¿y upewniæ siê jaka powinna byæ tre¶æ tego napisu. W momencie gdy uzyskam informacjê na temat tre¶ci tego napisu, dokonam niezbêdnych zmian w ¼ród³ach.
...
\title{Tytu³ pracy in¿ynierskiej}
\engtitle{English title}
\author{Jan Nowak}
\supervisor{dr hab. in¿. Imiê Nazwisko Prof. PWr, I-6}
%\guardian{dr hab. in¿. Imiê Nazwisko Prof. PWr, I-6} %nie u¿ywaæ je¶li opiekun jest t± sam± osob± co prowadz±cy pracê

%\date{2008} %standardowo u do³u strony tytu³owej umieszczany jest bie¿±cy rok, to polecenie pozwala wstawiæ dowolny rok

%poni¿ej jest lista kierunków i specjalno¶ci na wydziale elektroniki, nale¿y wybraæ w³a¶ciwe lub dopisaæ je¶li nie ma odpowiednich
\field{Automatyka i Robotyka (AIR)}
\specialisation{Robotyka (ARR)}
%\specialisation{Komputerowe sieci sterowania (ARK)}
%\specialisation{Systemy informatyczne w automatyce (ASI)}
%\specialisation{Komputerowe systemy zarz±dzania \\procesami produkcyjnymi (ARS)}
...
%\specialisation{In¿ynieria d¼wiêku (EID)}
...
%\specialisation{In¿ynieria systemów informatycznych (INS)}
%\specialisation{In¿ynieria internetowa (INT)}
...
%poni¿ej znajduje siê przyk³adowa tre¶æ dalszej czê¶ci dokumentu, zainteresowanych zachêcam do rozszyfrowania frazy "Lorem ipsum" :)
\chapter{Lorem ipsum}
